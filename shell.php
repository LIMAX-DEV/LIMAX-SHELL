 ...
 * LIMAX SHELL V2.6
 * @author LIMAX DEV
 * @github https://github.com/LIMAX-DEV
 */
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        ...
                                        <div class="brand text-center">
                                             <div style="font-size: 48px; font-weight: bold; color: #9b59b6;">
                                        <span style="border: 3px solid #9b59b6; padding: 10px 20px; border-radius: 10px;">
                                          LIMAX
                                        </span>
                                       </div>
                                      </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://github.com/LIMAX-DEV" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">LIMAX DEV</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/LIMAX-DEV" target="_blank" class="app-v-title"> LIMAX SHELL <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: LIMAX DEV</p>
                        <p>GitHub: <a href="https://github.com/LIMAX-DEV">https://github.com/LIMAX-DEV</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/LIMAX-DEV" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/LIMAX-DEV" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if (!FM_READONLY) { ?>
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <table class="table compact-table" data-bs-theme="<?php echo FM_THEME; ?>">
                        <tr>
                            <th></th>
                            <th><b><?php echo lng('Owner') ?></b></th>
                            <th><b><?php echo lng('Group') ?></b></th>
                            <th><b><?php echo lng('Other') ?></b></th>
                        </tr>
                        <tr>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://github.com/LIMAX-DEV" target="_blank" class="float-right text-muted">LIMAX SHELL <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://github.com/LIMAX-DEV" target="_blank" class="float-right text-muted">LIMAX SHELL <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'LIMAX SHELL<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Web based SHELL in PHP, Manage your files efficiently and easily with LIMAX SHELL">
        <meta name="author" content="LIMAX DEV">
...
?>
    ...
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Web based SHELLin PHP, Manage your files efficiently and easily with LIMAX SHELL">
        <meta name="author" content="LIMAX DEV">
        <meta name="robots" content="noindex, nofollow">
        <meta name="googlebot" content="noindex">
        <?php if ($favicon_path) {
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "LIMAX")); ?></title>
        ...
        <style>
            ...
            *::after {
            ...
            .main-nav {
                padding: 0.2rem 1rem;
                box-shadow: 0 4px 5px 0 rgba(155, 89, 182, 0.14), 0 1px 10px 0 rgba(155, 89, 182, 0.12), 0 2px 4px -1px rgba(155, 89, 182, 0.2);
        ...
        if (FM_THEME == "dark"): ?>
            <style>
                :root {
                    --bs-bg-opacity: 1;
                    --bg-color: #9b59b6;
                    --bs-dark-rgb: 10, 10, 10 !important;
                    --bs-bg-opacity: 1;
                }
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'LIMAX SHELL';
        $tr['en']['AppTitle']       = 'SHELL';
        $tr['en']['Login']          = 'Sign in';
